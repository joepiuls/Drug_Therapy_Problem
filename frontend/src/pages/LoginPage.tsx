...
export const LoginPage: React.FC = () => {
  ...
  const handleDemoLogin = async (role: 'pharmacist' | 'hospital_admin' | 'state_admin') => {
    const demoCredentials = {
      pharmacist: { email: 'pharmacist@demo.com', password: 'demo' },
      hospital_admin: { email: 'admin@demo.com', password: 'demo' },
      state_admin: { email: 'state@demo.com', password: 'demo' }
    };

    const success = await login(demoCredentials[role].email, demoCredentials[role].password);
    if (success) {
      addToast(`Logged in as ${role.replace('_', ' ')}!`, 'success');
    }
  };
              ...
              <div className="mt-6">
                ...
                <div className="mt-4 space-y-2">
                  ...
                  <Button
                    variant="outline"
                    fullWidth
                    onClick={() => handleDemoLogin('state_admin')}
                  >
                    Demo State Admin
                  </Button>
                </div>
